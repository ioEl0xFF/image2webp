...
try:
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location("config_loader", "src/img2webp/config/loader.py")
        ...
        spec2 = importlib.util.spec_from_file_location("config", "src/img2webp/config/defaults.py")
